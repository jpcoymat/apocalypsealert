...
class LocationGroupsControllerTest < ActionController::TestCase
  ...
  test "should create location_group" do
    assert_difference('LocationGroup.count') do
      post :create, location_group: { code: @location_group.code, name: @location_group.name, organization_id: @location_group.organization_id }
    end
  ...
  test "should update location_group" do
    patch :update, id: @location_group, location_group: { code: @location_group.code, name: @location_group.name, organization_id: @location_group.organization_id }
    assert_redirected_to location_group_path(assigns(:location_group))
  end
